...
* In **Dependency Rule**, select **Up to Next Major Version** and enter `3.1.0` as the value, as shown:
...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "git@github.com/rudderlabs/rudder-integration-appsflyer-ios.git", from: "3.1.0")
    ],
    targets: [
